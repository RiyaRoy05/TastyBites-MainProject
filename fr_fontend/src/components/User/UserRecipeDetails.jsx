...
function UserRecipeDetails() {
    ...
    useEffect(() => {
        ...
        try{
            axios.get(baseUrl+'/fetch-favorite-status/'+user_id+'/'+urecipe_id)
            .then((res) =>{
    ...
    const markAsFavorite = () => {
        ...
        axios.post(baseUrl + '/user-add-favorite-recipe/', formData, {
            headers: {
    ...
    const removeFavorite = (pk) => {
        const formData = new FormData();
        formData.append('urecipe', urecipe_id);
        formData.append('user', user_id);
        formData.append('status', false);
        
        axios.get(baseUrl + '/user-remove-favorite-recipe/' + urecipe_id + '/' + user_id ,{
            headers: {
                'content-type': 'multipart/form-data'
            }
        })
